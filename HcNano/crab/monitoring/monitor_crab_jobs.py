...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--crablogdir', required=True, type=os.path.abspath,
    ...
    if not os.path.isdir(args.crablogdir):
        raise Exception('ERROR: simpack directory {} does not exist'.format(args.crablogdir))
    ...
    for fidx, f in enumerate(fproc):
        ...
        status_cmd = 'crab status {} > {}'.format(f, tmpfile)
