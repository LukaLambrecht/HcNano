...
#ifndef DStarMesonProducer_H
#define DStarMesonProducer_H
...
class DStarMesonProducer : public edm::stream::EDProducer<> {
  private:
  ...
  public:
    ...
    explicit DStarMesonProducer(const edm::ParameterSet&);
    ~DStarMesonProducer() override;
